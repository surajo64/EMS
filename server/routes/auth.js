...
import { deleteMessage, fetchEmployees, getAllMessage, getMessage, login, markRead, sendMessage } from '../controller/authController.js';
...
authRouter.get('/get-all-users',fetchEmployees );
